...
__IMPLEMENT_APPLICATION_RELEASE_TIME(SceneFoundry_pbr_renderer);
IMPLEMENT_APPLICATION_FACTORY(SceneFoundry_pbr_renderer);
...
namespace SceneFoundry_pbr_renderer
{
   ...
   application::application()
   {
      ...
      m_strAppId = "SceneFoundry/pbr-renderer";

      m_strAppName = "SceneFoundry/pbr-renderer";

      m_strBaseSupportId = "SceneFoundry_pbr_renderer";
   ...
   void application::init_instance()
   {
      ...
      factory()->add_factory_item <::SceneFoundry_pbr_renderer::document >();
