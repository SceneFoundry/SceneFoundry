...
namespace SceneFoundry_opengl_pbr_renderer
{
   ...
   class CLASS_DECL_SCENEFOUNDRY_OPENGL_PBR_RENDERER main_scene :
...
//BEGIN_GPU_PROPERTIES(::SceneFoundry_opengl_pbr_renderer::global_ubo)
...
//GPU_PROPERTY("pointLights", ::gpu_properties<::gpu::point_light>(), ::SceneFoundry_opengl_pbr_renderer::global_ubo::MAX_LIGHTS)
