...
#if defined(_SceneFoundry_opengl_pbr_renderer_project)
#define CLASS_DECL_SCENEFOUNDRY_OPENGL_PBR_RENDERER  CLASS_DECL_EXPORT
#else
#define CLASS_DECL_SCENEFOUNDRY_OPENGL_PBR_RENDERER  CLASS_DECL_IMPORT
#endif
