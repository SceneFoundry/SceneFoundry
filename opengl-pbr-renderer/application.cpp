...
__IMPLEMENT_APPLICATION_RELEASE_TIME(SceneFoundry_opengl_pbr_renderer);
IMPLEMENT_APPLICATION_FACTORY(SceneFoundry_opengl_pbr_renderer);
...
namespace SceneFoundry_opengl_pbr_renderer
{
   ...
   application::application()
   {
      ...
      m_strAppId = "SceneFoundry/opengl-pbr-renderer";

      m_strAppName = "SceneFoundry/opengl-pbr-renderer";

      m_strBaseSupportId = "SceneFoundry_opengl_pbr_renderer";
   ...
   void application::init_instance()
   {
      ...
      factory()->add_factory_item <::SceneFoundry_opengl_pbr_renderer::document >();
      factory()->add_factory_item <::SceneFoundry_opengl_pbr_renderer::main_frame >();
      factory()->add_factory_item <::SceneFoundry_opengl_pbr_renderer::impact >();
      factory()->add_factory_item <::SceneFoundry_opengl_pbr_renderer::pane_impact >();
