...
//     * @param path
//     */
//    Model(std::string path, ::pointer<Material> material, bool flipTexturesVertically);
...
//    ::pointer<Texture> loadMaterialTexture(aiMaterial* material, aiTextureType type);
...
//    std::map<std::string, ::pointer<Texture>> mTexturesLoaded;
//    ::pointer<Material> mMaterialOverride;
//};