...
VkSandboxOBJmodel::VkSandboxOBJmodel(sandbox_device& device, const Builder& builder)
...
::pointer<VkSandboxOBJmodel> VkSandboxOBJmodel::createModelFromFile(sandbox_device& device, const ::scoped_string & filepath, bool isSkybox)
{
    Builder builder{};
...
void VkSandboxOBJmodel::createVertexBuffers(const ::array_base<Vertex>& vertices)
{
...
void VkSandboxOBJmodel::createIndexBuffers(const ::array_base<uint32_t>& indices)
{
...
::array_base<VkVertexInputBindingDescription> VkSandboxOBJmodel::Vertex::getBindingDescriptions()
{
    return {
...
::array_base<VkVertexInputAttributeDescription> VkSandboxOBJmodel::Vertex::getAttributeDescriptions()
{
    return {
...
void VkSandboxOBJmodel::Builder::loadModel(const ::scoped_string & filepath, bool isSkybox) {
