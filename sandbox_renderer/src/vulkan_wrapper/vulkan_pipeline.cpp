...
::array_base<char> VkSandboxPipeline::readFile(const ::scoped_string & filepath)
{
...
void VkSandboxPipeline::createShaderModule(const ::array_base<char>& code, VkShaderModule* shaderModule)
{
