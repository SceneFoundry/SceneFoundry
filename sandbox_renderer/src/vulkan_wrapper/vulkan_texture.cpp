...
namespace vulkan
{
	...
	void sandbox_texture::KtxLoadCubemapFromFile(const ::scoped_string& name, ::string filename, VkFormat format, sandbox_device* device, VkQueue copyQueue, VkImageUsageFlags imageUsageFlags, VkImageLayout imageLayout)
	{
		m_bIsCubemap = true;
	...
	ktxResult sandbox_texture::loadKTXFile(::string filename, ktxTexture** target)
	{
