...
sandbox_device::sandbox_device(VkSandboxInstance& instance, SandboxWindow& window)
    : m_window(window),
      m_instance(instance)
{
    createSurface();
...
sandbox_device::~sandbox_device() {
    vkDestroyCommandPool(m_logicalDevice, m_commandPool, nullptr);
    vkDestroyDevice(m_logicalDevice, nullptr);
}


void sandbox_device::pickPhysicalDevice() {
...
void sandbox_device::createSurface() {
    m_window.createSurface(m_instance.instance(), &m_surface);
}
void sandbox_device::createLogicalDevice() {
...
void sandbox_device::createCommandPool() {
...
bool sandbox_device::isDeviceSuitable(VkPhysicalDevice device) {
...
bool sandbox_device::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
QueueFamilyIndices sandbox_device::findQueueFamilies(VkPhysicalDevice device) {
...
SwapChainSupportDetails sandbox_device::querySwapChainSupport(VkPhysicalDevice device) {
...
VkFormat sandbox_device::findSupportedFormat(
...
uint32_t sandbox_device::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
...
void sandbox_device::createBuffer(
    VkDeviceSize size,
...
VkResult sandbox_device::createBuffer(VkBufferUsageFlags usageFlags, VkMemoryPropertyFlags memoryPropertyFlags, VkDeviceSize size, VkBuffer* buffer, VkDeviceMemory* memory, void* data)
{
...
VkCommandBuffer sandbox_device::beginSingleTimeCommands() {
...
void sandbox_device::endSingleTimeCommands(VkCommandBuffer commandBuffer) {
...
void sandbox_device::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
...
void sandbox_device::copyBufferToImage(
    VkBuffer buffer,
    VkImage image,
    uint32_t width,
    uint32_t height,
...
void sandbox_device::createImageWithInfo(
...
void sandbox_device::transitionImageLayout(
    VkImage image,
    VkFormat format,
...
bool sandbox_device::hasStencilComponent(VkFormat format) {
    return (format == VK_FORMAT_D32_SFLOAT_S8_UINT) || (format == VK_FORMAT_D24_UNORM_S8_UINT);
}


VkCommandBuffer sandbox_device::createCommandBuffer(VkCommandBufferLevel level, bool begin)
{
    return createCommandBuffer(level, m_commandPool, begin);
}

VkCommandBuffer sandbox_device::createCommandBuffer(VkCommandBufferLevel level, VkCommandPool pool, bool begin)
{
...
void sandbox_device::flushCommandBuffer(VkCommandBuffer commandBuffer, VkQueue queue, VkCommandPool pool, bool free)
{
...
void sandbox_device::flushCommandBuffer(VkCommandBuffer commandBuffer, VkQueue queue, bool free) {
...
VkSurfaceFormatKHR sandbox_device::chooseSwapSurfaceFormat(
...
VkPresentModeKHR sandbox_device::chooseSwapPresentMode(
...
VkExtent2D sandbox_device::chooseSwapExtent(
...
uint32_t sandbox_device::getMemoryType(uint32_t typeBits, VkMemoryPropertyFlags properties, VkBool32* memTypeFound) const
{
