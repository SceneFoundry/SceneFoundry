...
std::unique_ptr<sandbox_descriptor_set_layout> sandbox_descriptor_set_layout::Builder::build() const {
    ...
    return std::make_unique<sandbox_descriptor_set_layout>(m_device, setBindings, layout);
}
...
void VkSandboxDescriptorPool::freeDescriptors(::array_base<VkDescriptorSet>& descriptors) const {
...
VkSandboxDescriptorWriter::VkSandboxDescriptorWriter(sandbox_descriptor_set_layout& setLayout, VkSandboxDescriptorPool& pool)
