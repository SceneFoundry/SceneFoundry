...
namespace sandbox_renderer
{
   ...
   void sandbox_renderer::createGlobalDescriptorObjects() {
      ...
      m_pool = ::sandbox_renderer::sandbox_descriptor_pool::Builder{ m_pgpudevice }
   ...
   void sandbox_renderer::updateSystems(::sandbox::IFrame * pframe, GlobalUbo& ubo, float deltaTime)
   {
   ...
   void sandbox_renderer::renderSystems(::sandbox::IFrame * pframe) {
   ...
   bool rendernisFrameInProgress() const { return m_bIsFrameStarted; }
