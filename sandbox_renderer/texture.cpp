...
namespace sandbox_renderer
{
	...
	// bool texture::STBLoadFromFile(const ::scoped_string& filename)
	// {
	//
	...
	// 		VK_CHECK_RESULT(vkCreateImage(pdevice->m_logicalDevice, &imageCreateInfo, nullptr, &mappableImage));
	//
	// 		// Get memory requirements for this image
	// 		// like size and alignment
	// 		vkGetImageMemoryRequirements(pdevice->m_logicalDevice, mappableImage, &memReqs);
	...
	// 		VK_CHECK_RESULT(vkAllocateMemory(pdevice->m_logicalDevice, &memAllocInfo, nullptr, &mappableMemory));
	//
	// 		// Bind allocated image for use
	// 		VK_CHECK_RESULT(vkBindImageMemory(pdevice->m_logicalDevice, mappableImage, mappableMemory, 0));
	//
	...
	// 		vkGetImageSubresourceLayout(pdevice->m_logicalDevice, mappableImage, &subRes, &subResLayout);
	//
	// 		// Map image memory
	// 		VK_CHECK_RESULT(vkMapMemory(pdevice->m_logicalDevice, mappableMemory, 0, memReqs.size, 0, &data));
	//
	// 		// Copy image data into memory
	// 		memcpy(data, ktxTextureData, memReqs.size);
	//
	// 		vkUnmapMemory(pdevice->m_logicalDevice, mappableMemory);
	//
	...
	// 		pdevice->m_enabledFeatures.samplerAnisotropy ? VK_TRUE : VK_FALSE;
	// 	samplerCreateInfo.maxAnisotropy =
	// 		samplerCreateInfo.anisotropyEnable
	// 		? pdevice->m_deviceProperties.limits.maxSamplerAnisotropy
	// 		: 1.0f;
	//
	...
	bool texture::LoadCubemap(const ::preallocated_array_base< ::array_base <::string>, 6 >& faces) {
		m_bIsCubemap = true;
		//
		// int w, h, c;
		// ::array_base<stbi_uc*> images(6);
		// for (int i = 0; i < 6; i++) {
	...
	// ktxResult texture::loadKTXFile(::string filename, ktxTexture** target)
	// {
