...
#undef STR
	...
	VkBool32 getSupportedDepthFormat(VkPhysicalDevice physicalDevice, VkFormat* depthFormat)
	{
		...
		::array_base<VkFormat> formatList = {
	...
	{
		::array_base<VkFormat> stencilFormats = {
			VK_FORMAT_S8_UINT,
			VK_FORMAT_D16_UNORM_S8_UINT,
			VK_FORMAT_D24_UNORM_S8_UINT,
			VK_FORMAT_D32_SFLOAT_S8_UINT,
...
//#if defined(_WIN32)
//		if (!errorModeSilent) {
//			auto pmessagebox = ::system()->message_box(message);
//			pmessagebox->send();
...
//	}
	...
	VkShaderModule loadShader(AAssetManager* assetManager, const char* fileName, VkDevice pdevice)
	{
		...
		VK_CHECK_RESULT(vkCreateShaderModule(pdevice, &moduleCreateInfo, NULL, &shaderModule));
