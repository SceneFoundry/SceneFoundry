...
//          vkDestroyDescriptorSetLayout(m_pgpudevice->device(), m_descriptorSetLayout, nullptr);
...
//
//       if (vkCreateDescriptorPool(m_pgpudevice->device(), &descriptorPoolInfo, nullptr, &m_descriptorPool) !=
//          VK_SUCCESS) {
...
//          vkDestroyDescriptorPool(m_pgpudevice->device(), m_descriptorPool, nullptr);
...
//
//       // Try to allocate
//       if (vkAllocateDescriptorSets(m_pgpudevice->device(), &allocInfo, &descriptor) != VK_SUCCESS) {
//          return false;
//       }
//
//       return true;
...
//       vkResetDescriptorPool(m_pgpudevice->device(), m_descriptorPool, 0);
//    }
//
//    // *************** Descriptor Writer *********************
//
...
//          write.dstSet = set;
//       }
//       vkUpdateDescriptorSets(m_pool.m_pgpudevice->device(), m_writes.size(), m_writes.data(), 0, nullptr);
//    }
//
// } // namespace sandbox_renderer
//
