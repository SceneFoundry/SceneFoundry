...
namespace sandbox_renderer
{
      ...
      ::sandbox_renderer::sandbox_device * pdevice, const ::scoped_string& filepath, bool isSkybox)
   {
      ...
      return øcreate_pointer<sandbox_object_model>(pdevice, builder);
   }



   void sandbox_object_model::createVertexBuffers(const ::array_base<Vertex>& vertexes)
   {
   ...
   void sandbox_object_model::createIndexBuffers(const ::array_base<uint32_t>& indexes)
   {
   ...
   void sandbox_object_model::draw(::gpu::command_buffer * pcommandbuffer)
   {
   ...
   void sandbox_object_model::bind(::gpu::command_buffer * pcommandbuffer)
   {
   ...
   ::array_base<VkVertexInputBindingDescription> sandbox_object_model::Vertex::getBindingDescriptions()
   {
      return {
   ...
   ::array_base<VkVertexInputAttributeDescription> sandbox_object_model::Vertex::getAttributeDescriptions()
   {
      return {
